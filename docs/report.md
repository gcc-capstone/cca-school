...
- **MVP:** Teachers can contact the parents of a particular student in a one-on-one conversation.
    - Amanda Bright has been struggling in her sixth-grade math class. Her teacher, Ms. Roller, wants to meet with her parents to discuss some possible options to support Amanda better. Ms. Roller is able to start a new conversation in the app with only Amanda's parents so that they can talk out some options.
